...
<title>Dash:lycée_classique_khar kane</title>
...
<div id="wrap"> 
    ...
    <header> 
      <!-- Logo -->
      <div class="container">
        <div class="logo"> <img  class="img-responsive" src="images/logooo.png" alt="logo" > </div>
        <!-- INFO -->
          ...
          <ul class="nav ownmenu">
            ...
            <li class="active"><a href="#"> Eleve </a> 
              <ul class="dropdown animated-3s fadeInRight">
                <li class="active"> <a href="ajouteleve.php">Ajouter un elève</a> </li>
        ...
        <div class="row margin-top-100 margin-bottom-100">
          <div class="col-md-10 col-sm-10 col-xs-12"> 
            ...
            <div class="heading text-left">
              <a href="ajouteleve.html"><h5>Ajouter un elève</h5></a>
