...
<div id="wrap"> 
    ...
    <header> 
      ...
      <!-- Logo -->
      <div class="container">
        <div class="logo"><img  class="img-responsive" src="images/logooo.png" alt="" ></div>
          ...
          <ul class="nav ownmenu">
            ...
            <li class="active"> <a href="#"> Eleve </a>
              <ul class="dropdown animated-3s fadeInRight">
                ...
                <li class="active"> <a href="listeeleve.php">Lister les elèves</a> </li>
              </ul>
            </li>
            <li> <a href="#"> Classe </a>
              <ul class="dropdown animated-3s fadeInRight">
